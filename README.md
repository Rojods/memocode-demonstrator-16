...
Using the global labels is what enables OurTool to cross-reference different parts of the OS and HW descriptions to build a linked and coherent platform model.
...
Since composability is a key elements of DSI and OurTool, it is only natural to expect that combining the previous two case studies is possible. 
In fact, it is!
...
Because of the OurMDETools framework, XXxXxXx directly consume [SDF3](https://www.es.ele.tue.nl/sdf3/manuals/xml/sdf/) XML specification files.
